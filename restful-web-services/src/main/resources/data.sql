...
insert into jwt_user_details(id, username, password)
values (2L, 'sept2', '$2a$10$3zHzb.Npv1hfZbLEU5qsdOju/tk2je6W6PnNnY.c1ujWPcZh4PL6e');
...
insert into todo(id, username,description,target_date,is_done)
values(10004, 'sept2', 'Deadline 1', sysdate(), false);

insert into todo(id, username,description,target_date,is_done)
values(10005, 'sept2', 'Deadline 2', sysdate(), false);
